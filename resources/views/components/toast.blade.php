                    ...
                    <template x-if="!toast.html">
                        <div class="relative">
                            <div
                                ...
                                x-bind:class="{ 'text-green-500' : toast.type=='success', 'text-blue-500' : toast.type=='info', 'text-orange-400' : toast.type=='warning', 'text-red-500' : toast.type=='danger', 'text-gray-800' : toast.type=='default' }"
                            >
                                ...
                                <p class="text-sm font-medium leading-none text-gray-800" x-text="toast.message"></p>
                            </div>
